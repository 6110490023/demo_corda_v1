...
public class CreateClaim {
    ...
    public static class CreateClaimInitiator extends FlowLogic<SignedTransaction>{
        ...
        public SignedTransaction call() throws FlowException {
            ...
            TransactionBuilder txBuilder = new TransactionBuilder(notary)
                    ...
                    .addCommand(new CreateClaimContract.Commands.CreateClaim(),
    ...
    @InitiatedBy(CreateClaimInitiator.class)
    public static class CreateClaimResponder extends FlowLogic<Void>{

        //private variable
        private FlowSession counterpartySession;

        public CreateClaimResponder (FlowSession counterpartySession) {
